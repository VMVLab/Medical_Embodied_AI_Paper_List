...
* ​[25][**AIM, 2025**] Based therapist skill transfer learning framework for upper-limb rehabilitation exoskeleton [paper](XXX)
* ​[26][**Frontiers in Bioengineering and Biotechnology, 2025**] AI-driven hybrid rehabilitation: synergizing robotics and electrical stimulation for upper-limb recovery after stroke [paper](XXX)
* ​[27][**APMS, 2020**] Autonomous mobile robots in hospital logistics [paper](XXX)
* ​[28][**Autonomous Robots, 2024**] Boosting the hospital by integrating mobile robotic assistance systems: a comprehensive classification of the risks to be addressed [paper](XXX)
* ​[29][**IC-BIS, 2024**] Research on multirobot collaboration platform for logistic distribution of medical consumables in the operating room [paper](XXX)
* ​[30][**ICSR, 2024**] Interaction matters when it comes to hand disinfection using robots at hospitals [paper](XXX)
* ​[31][**arXiv, 2025**] Large model empowered embodied AI: A survey on decision-making and embodied learning [paper](XXX)
* ​[32][**arXiv, 2025**] Towards robust and secure embodied AI: A survey on vulnerabilities and attacks [paper](XXX)
* ​[33][**arXiv, 2025**] UAVs meet agentic AI: A multidomain survey of autonomous aerial intelligence and agentic UAVs [paper](XXX)
* ​[34][**arXiv, 2025**] Embodied AI: From LLMs to world models [paper](XXX)
* ​[35][**DTPI, 2024**] Embodied intelligent driving: Key technologies and applications [paper](XXX)
* ​[36][**arXiv, 2025**] Multi-agent autonomous driving systems with large language models: A survey of recent advances [paper](XXX)
